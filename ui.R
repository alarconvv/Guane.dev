                                                               ...
                                                               fluidRow(
                                                                 ...
                                                                 column(2, sidebarPanel(width = "100%",p("Graphic Controls", style = "align:center;text-align:center; font-weight: bold"),hr(),
                                                                                        ...
                                                                                        accordion_panel( title = h5(" \ Tree and edge design"),
                                                                                                         ...
                                                                                                         conditionalPanel(condition= "input.typeDisML == 'fan' || input.typeDisML == 'radial' ",
                                                                                                                          numericInput(inputId = "rotateTreeDisML",
                                                                                                                                       label = "Rotate tree",value = 0 ,min =-360,
                                                                                                                                       max =360 ,step =0.1 ,width = "40%"),
                                                                                                                          numericInput(inputId = "openAngleDisML",
                                                                                                                                       label = "Open angle",
                                                                                                                                       value = 0.1 ,min =0.1,
                                                                                                                                       max =360 ,step =0.1 ,width = "40%"),
                                                                                                         ),
                                                                                                         
                                                                                                         awesomeCheckbox(inputId = "edgeLenghtDisML",
                                                                                                                         label = strong("Use edge lengths"), 
                                                                                                                         value = T,status = "info"),
                                                                                                         
                                                                                                         numericInput(inputId = "edgeWidthDisML",
                                                                                                                      label = "set edge width",value = 1 ,
                                                                                                                      min =0.1 ,max =10 ,step =0.01 ,width = "40%"),
                                                                                                         
                                                                                                         selectInput(selected = "plain",
                                                                                                                     inputId = "edgetlyDisML",
                                                                                                                     label = strong('Line Type'),
                                                                                                                     choices = c( "plain" = "1" ,  "dashed" = "2", 
                                                                                                                                  "dotted" = "3",  "dotdash" = "4", 
                                                                                                                                  "longdash" = "5" , "twodash" = "6")
                                                                                        ...
                                                                                        accordion_panel( title = h5(" \ Lables"),
                                                                                                         value = "lablesDisML",
                                                                                                         awesomeCheckbox(inputId = "tipLabelsDisML",label = strong("Show tip lables"), 
                                                                                                                         value = T,status = "info"),
                                                                                                         awesomeCheckbox(inputId = "aligntiplabelDisML",
                                                                                                                         label = strong("Align tip label"), 
                                                                                                                         value = F,status = "info"),
                                                                                                         awesomeCheckbox(inputId = "underscoreDisML",
                                                                                                                         label = strong("Underscore"), 
                                                                                                                         value = F,status = "info"),
                                                                                                         selectInput(selected = "plain text",
                                                                                                                     inputId = "fontDisML",
                                                                                                         ...
                                                                                                         selectInput(selected = NULL,
                                                                                                                     ...
                                                                                                                     choices = c( "left-justification" = "0" ,  "centering" = "0.5", 
                                                                                                                                  "right-justification" = "1", NULL)),
                                                                                                         numericInput(inputId = "srtDisML",
                                                                                                                      label = "Label rotation",
                                                                                                                      value = 0.1 ,min =0.1,
                                                                                                                      max =360 ,step =0.1 ,width = "40%"),
                                                                                                         numericInput(inputId = "labeloffsetDisML",
                                                                                                                      label = "Label offset",value = 0.01 ,
                                                                                                                      min =0.1 ,max =10 ,step =0.001 ,width = "40%"),
                                                                                                         selectInput(selected = "horizontal",
                                                                                                                     inputId = "lab4utDisML",
                                                                                        ...
                                                                                        accordion_panel( title = h5(" \ Margins"),
                                                                                                         value = "marginsDisML",
                                                                                                         awesomeCheckbox(inputId = "nomarginDisML",
                                                                                                                         label = strong("No margin"), 
                                                                                                                         value = T,status = "info"),
                                                                                        ...
                                                                                        accordion_panel( title = h5(" \ Nodes"),
                                                                                                         value = "NodesDisML",
                                                                                                         awesomeCheckbox(inputId = "nodelabelDisML",
                                                                                                                         label = strong("Show node label"), 
                                                                                                                         value = F,status = "info"),
                                                                                                         
                                                                                                         numericInput(inputId = "nodeWidthDisML",
                                                                                                                      label = "Node width",value = 1 ,
                                                                                                                      min =0.1 ,max =10 ,step =0.01 ,width = "40%"),
                                                                                                         
                                                                                                         selectInput(selected = "plain",
                                                                                                                     inputId = "nodeltyDisML",
                                                                                                                     label = strong('Line Type'),
                                                                                                                     choices = c( "plain" = "1" ,  "dashed" = "2", 
                                                                                                                                  "dotted" = "3",  "dotdash" = "4", 
                                                                                                                                  "longdash" = "5" , "twodash" = "6")),
